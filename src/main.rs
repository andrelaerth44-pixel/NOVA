...
struct Vm { vars:HashMap<String,Value>, fns:HashMap<String,Function> }
impl Vm {
    fn new()->Self{Self{vars:HashMap::new(),fns:HashMap::new()}}
...
fn main(){
    ...
    if a[1]=="version"{println!("NOVA 1.3.0");return}
