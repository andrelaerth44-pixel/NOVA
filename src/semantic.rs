        ...
        match e {
            ...
            Expr::Call(name, args) => {
                ...
                let builtin = match name.as_str() {
                    ...
                    "current_dir" => Some((vec![], crate::types::Type::String)),
                    "path_join" => Some((vec![crate::types::Type::String, crate::types::Type::String], crate::types::Type::String)),
                    "path_basename" | "path_dirname" | "path_ext" | "path_stem" => Some((vec![crate::types::Type::String], crate::types::Type::String)),
                    "make_dir" | "remove_file" => Some((vec![crate::types::Type::String], crate::types::Type::Null)),
                    "list_dir" => Some((vec![crate::types::Type::String], crate::types::Type::Array(Box::new(crate::types::Type::String)))),
                    "json_parse" => Some((vec![crate::types::Type::String], crate::types::Type::Any)),
                    "json_stringify" => Some((vec![crate::types::Type::Any], crate::types::Type::String)),
