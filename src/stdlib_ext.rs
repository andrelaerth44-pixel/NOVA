...
pub fn sha256_hex(input:&[u8])->String{
    const K:[u32;64]=[
        ...
        0xd807aa98,0x12835b01,0x243185be,0x550c7dc3,0x80deb1fe,0x9bdc06a7,0xc19bf174,0xe49b69c1,0xefbe4786,
        ...
        0x2748774c,0x34b0bcb5,0x391c0cbe,0x4ed8aa4a,0x5b9cca4f,0x682e6ff3,0x748f82ee,0x78a5636f,
        0x84c87814,0x8cc70208,0x90befffa,0xa4506ceb,0xbef9a3f7,0xc67178f2
    ];
    let mut data=input.to_vec();
    let bit_len=(data.len() as u64)*8;
    data.push(0x80);
    while (data.len()+8)%64!=0{data.push(0);}
    data.extend_from_slice(&bit_len.to_be_bytes());
    let mut h=[0x6a09e667u32,0xbb67ae85,0x3c6ef372,0xa54ff53a2,0x510e527f,0x9b05688c,0x1f83d9ab,0x5be0cd19];
    for chunk in data.chunks_exact(64){
        ...
        for i in 0..8{h[i]=h[i].wrapping_add([a,b,c,d,e,f,g,hh][i]);}
    }
